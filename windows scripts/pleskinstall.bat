...
c:\Tools\parallels_installer_3.15.14.exe --select-release-id PANEL_11_0_9_WIN --install-component base --install-component awstats --install-component mailenable --install-component dns --install-component spamassassin --install-component mysql-client --install-component phpmyadmin --install-component plesk-migration-manager --install-component php53 --install-component atmail --install-component webmail --no-daemon
